...
import {
  ...
  IsWindowObjectExist,
  PrecisionDate
} from "./chunk-7UDWPM5M.js";
import {
  EngineStore,
  PerformanceConfigurator
} from "./chunk-SAWWEFK2.js";
import {
  Observable
} from "./chunk-SIOQQVNJ.js";
import {
  Logger
} from "./chunk-6OCBLQT7.js";
import {
  ShaderStore
} from "./chunk-7ICDJKWN.js";
...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!_registeredTextureLoaders.has(extension)) {
    if (extension.endsWith(".ies")) {
      registerTextureLoader(".ies", () => import("./iesTextureLoader-CTI2PSDX.js").then((module) => new module._IESTextureLoader()));
    }
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", () => import("./ddsTextureLoader-7J2FMVCN.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", () => import("./basisTextureLoader-ZU6FIWAW.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", () => import("./envTextureLoader-RCJJDQTZ.js").then((module) => new module._ENVTextureLoader()));
    }
    if (extension.endsWith(".hdr")) {
      registerTextureLoader(".hdr", () => import("./hdrTextureLoader-2RKMAUOK.js").then((module) => new module._HDRTextureLoader()));
    }
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", () => import("./ktxTextureLoader-GWYVYILG.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", () => import("./ktxTextureLoader-GWYVYILG.js").then((module) => new module._KTXTextureLoader()));
    }
    if (extension.endsWith(".tga")) {
      registerTextureLoader(".tga", () => import("./tgaTextureLoader-NBDLJID2.js").then((module) => new module._TGATextureLoader()));
    }
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", () => import("./exrTextureLoader-5I52435F.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
//# sourceMappingURL=chunk-YN4XOQWL.js.map
