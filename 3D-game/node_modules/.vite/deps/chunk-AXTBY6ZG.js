import {
  Scene
} from "./chunk-IVOPATB6.js";
import {
  ApplyPostProcess,
  CubeMapToSphericalPolynomialTools,
  PostProcess,
  SphericalPolynomial
} from "./chunk-MNQENN62.js";
import {
  BaseTexture
...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-LXFKJPDK.js");
      } else {
        await import("./rgbdDecode.fragment-CNM7DQGA.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-AQZSGUHA.js");
    } else {
      await import("./rgbdEncode.fragment-E246KQAV.js");
    }
...
//# sourceMappingURL=chunk-AXTBY6ZG.js.map
