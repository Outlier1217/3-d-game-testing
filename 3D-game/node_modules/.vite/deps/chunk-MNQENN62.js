import {
  ...
  RenderingManager,
  SmartArray
} from "./chunk-MAMRZK2T.js";
import {
  PerfCounter
} from "./chunk-JGYVQTMA.js";
import {
  BaseTexture,
  Texture
} from "./chunk-LD4BKNFE.js";
import {
  SerializationHelper
} from "./chunk-RZRDQHXX.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
} from "./chunk-BPFHWZAL.js";
import {
  Color3
} from "./chunk-3P64WKRL.js";
import {
  Matrix,
  TmpVectors,
  ToLinearSpace,
  ...
  Vector3,
  _ObserveArray
} from "./chunk-SHSRV3QG.js";
import {
  HasStencilAspect,
  ThinEngine,
  WebGLDataBuffer,
  WebGLHardwareTexture
} from "./chunk-3ZKCV24D.js";
import {
  EffectWrapper
} from "./chunk-IS23XVCX.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-COVP5USQ.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-F3HQRHHM.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-YQ5FDSRM.js")]));
    }
  }
  /**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-UDUGLVCH.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-N3WCKGFB.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-JZIDKUV3.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-HSK4PLDO.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-CMEYKO47.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-VWE32BYF.js");
    } else {
      await import("./lod.fragment-EXELCTIT.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-U4NJZVOR.js");
    } else {
      await import("./lod.fragment-2PATAUS2.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-MNQENN62.js.map
